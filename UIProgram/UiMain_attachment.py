...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "车辆零部件的表面缺陷视觉检测系统"))
        ...
        self.label_3.setText(_translate("MainWindow", "车辆零部件的表面缺陷视觉检测系统"))
        self.label_2.setText(_translate("MainWindow", "团队：掌声有请下一队"))
        self.label_12.setText(_translate("MainWindow", "视觉赋能，引擎新程"))
